package com.colin.rabbitmq.direct.consumerack.rabbitmqlistener;
 ...
 * @Author: sxf
 * @Date: 2020-6-2
 * @Description: 直连型交换器 消费者
 */
@Component
@RabbitListener(queues = "${mq.config.queue.log}")
public class LogDirectReceiver {
    ...
    public void process(@Payload String body, Channel channel, @Headers Map<String, Object> headers){
        ...
        try{
            ...
            System.out.println("LogDirectReceiver消费者收到消息  : " + body.toString());
