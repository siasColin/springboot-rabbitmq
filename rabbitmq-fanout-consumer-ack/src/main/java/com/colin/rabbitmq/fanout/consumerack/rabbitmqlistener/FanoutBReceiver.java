package com.colin.rabbitmq.fanout.consumerack.rabbitmqlistener;
 ...
 * @Author: sxf
 * @Date: 2020-6-2
 * @Description: 扇型交换器 fanoutB队列 消费者
 */
@Component
@RabbitListener(queues = "${mq.config.queue.fanoutB}")
public class FanoutBReceiver {
    ...
    public void process(@Payload String body, Channel channel, @Headers Map<String, Object> headers){
        ...
        try{
            ...
            System.out.println("FanoutBReceiver消费者收到消息  : " + body.toString());
